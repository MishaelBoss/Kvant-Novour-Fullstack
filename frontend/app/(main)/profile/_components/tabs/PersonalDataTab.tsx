...
export function PersonalDataTab({ user }: Props) {
    return (
        <main className="flex-1 bg-white rounded-3xl p-6 md:p-10 shadow-sm border border-gray-200/50">
            <section className="mb-12 relative pl-10">
                <svg xmlns="http://www.w3.org/2000/svg" width={24} height={24} className="left-0 absolute top-0">
            ...
            <Separator.Root className="h-px bg-gray-100 my-10" />
