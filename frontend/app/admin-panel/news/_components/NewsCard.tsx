...
import { INewsTest, NewsType } from "@/app/types/news.interface";
    ...
    return (
        <div className="bg-white rounded-[20px] p-6 shadow-sm border border-gray-200/50 flex flex-col gap-4">
            ...
            <div className="flex items-center gap-3 flex-wrap">
                <select
                    value={q.type}
                    onChange={e => onUpdate(q.id, { type: e.target.value as NewsType })}
                    ...
                    {Object.entries(NEWS_TYPE_LABELS).map(([value, label]) => (
                    ...
                    <div className="relative rounded-xl overflow-hidden border border-gray-200 bg-gray-50">
                        ...
                        {q.media.type === 'image' && (
                            <Image
                                width={100}
                                height={100}
                                src={displayMedia(q.media.preview_url)}
                                alt="Медиа к вопросу"
                        ...
                        {q.media.type === 'audio' && (
                            <div className="p-4 flex items-center gap-3">
                                ...
                                <audio controls src={displayMedia(q.media.preview_url)} className="flex-1 h-8" />
                            </div>
                        )}
                        {q.media.type === 'video' && (
                            <video
