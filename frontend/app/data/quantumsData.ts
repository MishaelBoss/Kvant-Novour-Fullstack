...
export const QUANTUMS = [
    ...
    },
    {
        ...
        age: "11-17 лет",
        type: "Бюджет",
        icon: "/hi-tech-quantum.webp",
        badgeColor: "bg-amber-100 text-amber-700 border-amber-200",
        skills: [
            "Работа на лазерных станках",
    ...
    },
    {
        ...
        age: "11-17 лет",
        type: "Бюджет",
        icon: "/english-quantum.webp",
        badgeColor: "bg-indigo-100 text-indigo-700 border-indigo-200",
        skills: [
            "Чтение IT-документации",
